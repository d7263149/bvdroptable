...
export const DefaultChain: ReservoirChain = {
  ...
  listingCurrencies: [
    ...
    {
        ...bluesparrowCurrencyBase,
        contract: '0x24ccedebf841544c9e6a62af4e8c2fa6e5a46fde',
      },
  ],
...
export default [
  ...
  
  {
    ...
    coingeckoId: 'MATIC',
    collectionSetId: process.env.NEXT_PUBLIC_MUMBAI_COMMUNITY,
...
  },
  {
    ...
    coingeckoId: 'etethereumhe',
    collectionSetId: process.env.NEXT_PUBLIC_SEPOLIA_COMMUNITY,
