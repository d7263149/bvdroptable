...
const [image, setImage] = useState<File | null>(null)
 ...
 const forvalue:any = collection.id; 
 const forvalue1 = forvalue.toUpperCase(); 

 const handleSubmit1 = async () => {
   const { data, error } = await supabase
      .from('dropinfo')
    .select('*')
    .ilike('collectionaddress', forvalue1)
setCountries(data);
// console.log('forvalue1',data);

}
handleSubmit1();

const tovalueicon = countries?.[0]?.icon;
// console.log('tovalueicon',tovalueicon)
...
<Img
                    ...
                    src={optimizeImage('https://gaqiyoafnzsovcorfqli.supabase.co/storage/v1/object/public/test/userId/'+ tovalueicon, 72 * 2)}
                    width={72}
                    height={72}
                    css={{
                      width: 72,
