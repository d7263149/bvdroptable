...
// console.log('ham',theme)

  function onClick11(e: { preventDefault: () => void }) {
        e.preventDefault();
    console.log('The link was clicked.');
  window.location.href = `/${routePrefix}`
}

    function onClick12(e: { preventDefault: () => void }) {
        e.preventDefault();
    console.log('The link was clicked.');
        ...
        {isConnected ? (
          ...
          >
            ...
            {/* <Link href={`/${routePrefix}/collections/trending`}>
                    ...
                    <Link  href="#" onClick={onClick11} legacyBehavior>
              <Text
                onClick={onClick11}
                style="subtitle1"
                css={{
              ...
              >
                Home
                    ...
                    <Link  href="#" onClick={onClick12} legacyBehavior>
              <Text
                onClick={onClick12}
                style="subtitle1"
                css={{
