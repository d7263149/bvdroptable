...
export const AccountSidebar: FC = () => {
  ...
  function click1(e: { preventDefault: () => void }) {
        e.preventDefault();
    // console.log('The link was clicked.');
  window.location.href = `/portfolio/${address || ''}?tab=items`
}

  function click2(e: { preventDefault: () => void }) {
        e.preventDefault();
    // console.log('The link was clicked.');
  window.location.href = `/portfolio/${address || ''}?tab=listings`
}

  function click3(e: { preventDefault: () => void }) {
        e.preventDefault();
    // console.log('The link was clicked.');
  window.location.href = `/portfolio/${address || ''}?tab=offers`
}

  function click4(e: { preventDefault: () => void }) {
        e.preventDefault();
    // console.log('The link was clicked.');
  window.location.href = `/portfolio/${address || ''}?tab=activity`
}
              ...
              >
                <Flex direction="column" css={{ py: '$4', px: '$4' }}>
                  ...
                  <Grid css={{ gridTemplateColumns: '1fr 1fr', mt: 32 }}>
                    <Link href="#" onClick={click1} replace={true}>
                      <Flex
                        align="center"
                        css={{
                          gap: 6,
